...
@NoArgsConstructor
public class DamfilmsServerError extends Exception
{
	/**
	 * Auto-generated ID
	 */
	...
	public DamfilmsServerError(int id, String message, Exception exception)
	{
		super();
		this.id = id;
	...
	public DamfilmsServerError(int id, String message)
	{
		super();
		this.id = id;
		this.message = message;
